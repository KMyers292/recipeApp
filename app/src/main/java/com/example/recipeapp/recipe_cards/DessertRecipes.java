...
//------------------------------------------------------------------------------------------------//
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recipesButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(DessertRecipes.this, MainActivity.class));
            }
        });
        ...
        shoppingListButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(DessertRecipes.this, ShoppingList.class));
            }
        });
        ...
        adapter = new RecipeListItemAdapter(this, listManager.getRecipes(dessert));
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        adapter.updateItems(listManager.getRecipes(dessert));
                    }
                }
        );
