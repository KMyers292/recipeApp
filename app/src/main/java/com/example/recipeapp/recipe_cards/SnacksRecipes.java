...
public class SnacksRecipes extends AppCompatActivity
{
...
//------------------------------------------------------------------------------------------------//
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recipesButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(SnacksRecipes.this, MainActivity.class));
            }
        });
        ...
        shoppingListButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(SnacksRecipes.this, ShoppingList.class));
            }
        });
        ...
        adapter = new RecipeListItemAdapter(this, listManager.getRecipes(snacks));
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        adapter.updateItems(listManager.getRecipes(snacks));
                    }
                }
        );
