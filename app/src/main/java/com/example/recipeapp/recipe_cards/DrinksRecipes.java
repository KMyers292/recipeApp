...
public class DrinksRecipes extends AppCompatActivity
{
...
//------------------------------------------------------------------------------------------------//
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_drinks_recipes);
        ...
        recipesButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(DrinksRecipes.this, MainActivity.class));
            }
        });
        ...
        shoppingListButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(DrinksRecipes.this, ShoppingList.class));
            }
        });
        ...
        adapter = new RecipeListItemAdapter(this, listManager.getRecipes(drinks));
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        adapter.updateItems(listManager.getRecipes(drinks));
                    }
                }
        );
