...
//------------------------------------------------------------------------------------------------//
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recipesButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(LunchRecipes.this, MainActivity.class));
            }
        });
        ...
        shoppingListButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(LunchRecipes.this, ShoppingList.class));
            }
        });
        ...
        adapter = new RecipeListItemAdapter(this, listManager.getRecipes(lunch));
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        adapter.updateItems(listManager.getRecipes(lunch));
                    }
                }
        );
