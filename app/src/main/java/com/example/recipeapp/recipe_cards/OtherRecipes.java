...
//------------------------------------------------------------------------------------------------//
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recipesButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                startActivity(new Intent(OtherRecipes.this, MainActivity.class));
            }
        });
        ...
        shoppingListButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(OtherRecipes.this, ShoppingList.class));
            }
        });
        ...
        adapter = new RecipeListItemAdapter(this, listManager.getRecipes(other));
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i)
                    {
                        ...
                        adapter.updateItems(listManager.getRecipes(other));
                    }
                }
        );
